...
//	public String list(Model model, @RequestParam Long customerNum) {
//		
//		
...
//	}
	...
	public String todoUpdate(@RequestBody TodoEntity1 toDoEntity, @PathVariable Integer id) {
		this.toDoService.update(id, toDoEntity);
		return "redirect:/session-login/todo";
	}
