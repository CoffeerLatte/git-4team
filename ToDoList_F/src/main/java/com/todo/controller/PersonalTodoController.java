...
public class PersonalTodoController {
	...
	// read 
	@GetMapping("/get/{id}")
	public List<TodoEntity3> showTodoById(@PathVariable("id") int personal_id) {
	...
	public TodoEntity3 updateTodo(@PathVariable("personal_id") int personal_id,
	...
	// delete
	@GetMapping("/delete/{personal_id}/{content_id}")
	public void deleteTodo(@PathVariable("personal_id") int personal_id,
						@PathVariable("content_id") int content_id) {
